...
var _user$project$Go_Types$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {sessionColor: a, sessionUrl: b, sessionId: c, sessionSize: d, error: e, currentColor: f, board: g};
	});
var _user$project$Go_Types$Flags = F4(
	function (a, b, c, d) {
		return {black: a, url: b, id: c, size: d};
	});
var _user$project$Go_Types$Black = {ctor: 'Black'};
var _user$project$Go_Types$White = {ctor: 'White'};
var _user$project$Go_Types$DismissError = {ctor: 'DismissError'};
var _user$project$Go_Types$Update = function (a) {
	return {ctor: 'Update', _0: a};
};
var _user$project$Go_Types$Place = function (a) {
	return {ctor: 'Place', _0: a};
};

var _user$project$Go_Util$swap = F3(
	function (f, vb, va) {
		return A2(f, va, vb);
	});
var _user$project$Go_Util$zip = F2(
	function (xs, ys) {
		...
		if (((_p0.ctor === '_Tuple2') && (_p0._0.ctor === '::')) && (_p0._1.ctor === '::')) {
			return {
				...
				_1: A2(_user$project$Go_Util$zip, _p0._0._1, _p0._1._1)
			};
		} else {
			return {ctor: '[]'};
		}
...
var _user$project$Go_Util$pair = F2(
	function (a1, a2) {
...
var _user$project$Go_Decoders$decodeColor = function () {
	var tryDecode = function (s) {
		...
		switch (_p0) {
			case 'White':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Go_Types$White);
			case 'Black':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Go_Types$Black);
			default:
				return _elm_lang$core$Json_Decode$fail('Invalid color');
		}
	};
	return A2(_elm_lang$core$Json_Decode$andThen, tryDecode, _elm_lang$core$Json_Decode$string);
}();
var _user$project$Go_Decoders$decodeIndex = A3(
	...
	A3(
		...
		'x',
		_elm_lang$core$Json_Decode$int,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Go_Util$pair)));
var _user$project$Go_Decoders$decodeCell = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'color',
	_user$project$Go_Decoders$decodeColor,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'index',
		_user$project$Go_Decoders$decodeIndex,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Go_Util$pair)));
var _user$project$Go_Decoders$decodeUpdate = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'board',
	_elm_lang$core$Json_Decode$list(_user$project$Go_Decoders$decodeCell),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'turn',
		_user$project$Go_Decoders$decodeColor,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Go_Util$pair)));
var _user$project$Go_Decoders$decodeUpdateString = _elm_lang$core$Json_Decode$decodeString(_user$project$Go_Decoders$decodeUpdate);

var _user$project$Go_Game$verifyAll = F3(
	function (cell, funcs, model) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (a, b) {
...
var _user$project$Go_Game$verifyBounds = F2(
	function (model, _p0) {
		var _p1 = _p0;
		var _p3 = _p1._0._1;
		var _p2 = _p1._0._0;
		return ((_elm_lang$core$Native_Utils.cmp(_p2, 0) > -1) && ((_elm_lang$core$Native_Utils.cmp(_p2, model.sessionSize) < 0) && ((_elm_lang$core$Native_Utils.cmp(_p3, 0) > -1) && (_elm_lang$core$Native_Utils.cmp(_p3, model.sessionSize) < 0)))) ? _elm_lang$core$Maybe$Just(
			{
				ctor: '_Tuple2',
...
var _user$project$Go_Game$verifyClear = F2(
	function (model, _p4) {
		var _p5 = _p4;
		var _p7 = _p5._0;
		var _p6 = A2(_user$project$Go_Util$lookup, _p7, model.board);
		if (_p6.ctor === 'Just') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Just(
...
var _user$project$Go_Game$verifyTurn = F2(
	function (model, c) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Maybe$Just(model.sessionColor),
			model.currentColor) ? _elm_lang$core$Maybe$Just(c) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Go_Game$verify = F2(
	function (cell, model) {
		return A3(
			_user$project$Go_Game$verifyAll,
			cell,
			{
				ctor: '::',
				_0: _user$project$Go_Game$verifyBounds,
				_1: {
					ctor: '::',
					_0: _user$project$Go_Game$verifyTurn,
					_1: {
						ctor: '::',
						_0: _user$project$Go_Game$verifyClear,
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$Go_View$renderIndex = function (_p0) {
	var _p1 = _p0;
	var extraClass = function () {
		...
		if (_p2.ctor === 'Just') {
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.eq(_p2._0, _user$project$Go_Types$Black) ? 'black-cell' : 'white-cell',
				_1: true
			};
		} else {
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'board-cell', _1: true},
					_1: {
						ctor: '::',
						_0: extraClass,
						_1: {ctor: '[]'}
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Go_Types$Place(_p1._0)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$Go_View$renderBoard = F2(
	function (size, board) {
		...
		return A2(
			...
			A2(_elm_lang$core$List$map, _user$project$Go_View$renderIndex, cells));
	});

var _user$project$Go_Ws$encodeCell = function (_p0) {
	var _p1 = _p0;
	return A2(
...
var _user$project$Go_Ws$wsUrl = function (m) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		m.sessionUrl,
...
var _user$project$Go_Ws$sendMove = F2(
	function (m, c) {
		return A2(
			...
			_user$project$Go_Ws$wsUrl(m),
			_user$project$Go_Ws$encodeCell(c));
	});
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Place':
				var _p1 = A2(
					_user$project$Go_Game$verify,
					{ctor: '_Tuple2', _0: _p0._0, _1: model.sessionColor},
					model);
				if (_p1.ctor === 'Nothing') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								error: _elm_lang$core$Maybe$Just('Can\'t place piece')
							}),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								board: {ctor: '::', _0: _p2, _1: model.board}
							}),
						_1: A2(_user$project$Go_Ws$sendMove, model, _p2)
					};
				}
			case 'Update':
				var _p3 = _user$project$Go_Decoders$decodeUpdateString(_p0._0);
				if (_p3.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								board: _p3._0._1,
								currentColor: _elm_lang$core$Maybe$Just(_p3._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								error: _elm_lang$core$Maybe$Just('Can\'t parse server response')
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _user$project$Main$init = function (flags) {
	return {
		...
		_0: A7(
			_user$project$Go_Types$Model,
			flags.black ? _user$project$Go_Types$Black : _user$project$Go_Types$White,
			flags.url,
			flags.id,
			flags.size,
			_elm_lang$core$Maybe$Nothing,
							...
							return A2(
								...
								function (url) {
									return _elm_lang$core$Json_Decode$succeed(
										{black: black, id: id, size: size, url: url});
								},
